INSERT INTO examples (example_id,  organisation_id, example_type, product_name, example_max, example_allocated)
VALUES ('f3831f8c-c338-4ebe-a82a-e2fc1d1ff78a', 'e254f8c', 'user','customer-crm-co', 100,5);
INSERT INTO examples (example_id,  organisation_id, example_type, product_name, example_max, example_allocated)
